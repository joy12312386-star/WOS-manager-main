...
class OfficerService {
    // 取得指定日期的官職配置
    static async getAssignment(eventDate, officerType) {
    ...
    // 取得指定日期的所有官職配置
    static async getAssignmentsByDate(eventDate) {
    ...
    // 保存官職配置
    static async saveAssignment(eventDate, officerType, utcOffset, slotsData) {
    ...
    // 保存所有官職配置（批量）
    static async saveAllAssignments(eventDate, utcOffset, officers) {
    ...
    // 刪除指定日期的所有配置
    static async deleteByDate(eventDate) {
